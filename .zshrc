# Ghostty terminfo compatibility: older zsh has issues with xterm-ghostty
...
# defer heavy plugins until after the first prompt renders (starship shows instantly)
...
#############################################################################
# sem https://ataraxy-labs.github.io/sem/
#############################################################################
